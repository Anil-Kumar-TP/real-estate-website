        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p onClick={() => { changeDetail && onSubmit(); setChangeDetail((prev) => !prev) }} className='flex items-center'>Do you want to change your name? <span className='text-red-600 hover:text-red-700 cursor-pointer transition ease-in-out duration-200 ml-1'>{changeDetail ? "Apply Change" : "Edit"}</span></p>
              <p onClick={onLogOut} className='text-blue-600 hover:text-blue-800 cursor-pointer trasnsition duration-200 ease-in-out'>Sign Out</p>
            </div>
          </form>
        </div>
      </section>
